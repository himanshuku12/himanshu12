...
//     axios.get(API).then(
//         (succes) => {
//           localStorage.setItem("adminData", JSON.stringify(succes.data.admin))
//         }
//     ).catch(
//         (error) => {
//             console.log(error)
...
//     <h2 className="text-3xl font-extrabold text-blue-600 mb-6 text-center">Update Profile</h2>
...
//       <div className="mb-5">
//         <label htmlFor="contact" className="block text-sm font-semibold text-gray-600">
//           Contact
//         </label>
//         <input
//           type="text"
